...
# save.image("~/gale_qpcr_dec_8.RData")

# load("~/gale_qpcr_dec_8.RData")
...
# check to make sure have all same notes

# read in qpcr byline, updates for line 50 and 69 and other new lines
read.xls(xls="/Users/choonoo/WNV/Gale_12_8_15/Gale_qPCR_byLine_12_8_15.xlsx", sheet=1) -> qpcr_data
...
read.xls(xls="/Users/choonoo/WNV/Gale_12_8_15/Gale_qPCR_byMouse_12_8_15.xlsx", sheet=1) -> qpcr_data_mouse
...
write.table(file="./Gale_12_8_15/processed_qpcr/Gale_qPCR_byLine_GC_12_8_15.txt", x=qpcr_data_final_format_v2, sep="\t", quote=F, row.names=F)

write.table(file="./Gale_12_8_15/processed_qpcr/Gale_qPCR_byMouse_GC_12_8_15.txt", x=qpcr_data_mouse_v3, sep="\t", quote=F, row.names=F)
...
# full byline
read.xls(xls="./8-Dec-2015/Gale_qPCR_byLine_7-Dec-2015_final.xlsx", sheet=1) -> qpcr_line

names(qpcr_line)
names(qpcr_data_final_format_v2)
rbind(qpcr_line, qpcr_data_final_format_v2) -> qpcr_12_8_15

# make sure no duplicates
sum(duplicated(qpcr_12_8_15)) == 0

write.table(file="./Gale_12_8_15/processed_qpcr/Gale_qPCR_byLine_12_8_15_full_GC.txt", x=qpcr_12_8_15, sep="\t", quote=F, row.names=F)

# full bymouse
read.xls(xls="./8-Dec-2015/Gale_qPCR_byMouse_7-Dec-2015_final.xlsx", sheet=1) -> qpcr_bymouse

rbind(qpcr_bymouse, qpcr_data_mouse_v3) -> qpcr_bymouse_12_8_15

# make sure no duplicates
sum(duplicated(qpcr_bymouse_12_8_15)) == 0

write.table(file="./Gale_12_8_15/processed_qpcr/Gale_qPCR_byMouse_12_8_15_full_GC.txt", x=qpcr_bymouse_12_8_15, sep="\t", quote=F, row.names=F)
